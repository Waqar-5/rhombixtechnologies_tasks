    ...
    <div>
      ...
      <div className="h-56 sm:h-64 bg-gradient-primary relative overflow-hidden">
        ...
        {company.coverImage?.url && (
          <img src={getFileUrl(company.coverImage.url)} alt="" className="h-full w-full object-cover relative" />
        )}
      ...
      <div className="container -mt-12 pb-16">
        ...
        >
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <div className="relative z-10 -mt-16 sm:-mt-20 shrink-0 rounded-2xl bg-gradient-primary p-1 shadow-glass-lg">
